...
-- toutes les droits autres sites pour la table clients_am
...
-- toutes les droits autres sites pour la table commandes_am
...
-- toutes les droits autres sites pour la table details_commandes_am
